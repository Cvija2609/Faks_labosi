...
public class Primjer1 {
    public static void main(String[] args) throws ProductMustHaveAtLeastTwoVariablesException, NoElementException{
        IDomain u = Domain.intRange(1, 6);
// {1,2,3,4,5}
        IDomain u3 = Domain.intRange(1,6);
        IDomain u4 = Domain.intRange(1,7);
        IDomain u2 = Domain.combine(u, u);
        IDomain u5 = Domain.combine(u, u4);

        IFuzzySet rx = new CalculatedFuzzySet(
                u2,
                StandardFuzzySets.lambdaFunction(
                        u2.indexOfElement(DomainElement.of(1, 2)),
                        u2.indexOfElement(DomainElement.of(3, 3)),
                        u2.indexOfElement(DomainElement.of(5, 5))
                )
        );
